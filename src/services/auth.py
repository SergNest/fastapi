...
class Auth:
    ...
    def create_email_token(self, data: dict):
        ...
        :return: A token that is encoded with the user's email address, a timestamp of when it was created, and an expiration date
        :doc-author: Trelent
        """
        to_encode = data.copy()
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :return: A jwt token that contains the data passed to it as well as the time of creation and expiration
        :doc-author: Trelent
        """
        to_encode = data.copy()
        if expires_delta:
    ...
    async def decode_refresh_token(self, refresh_token: str):
        ...
        :return: The email address of the user associated with the refresh token
        :doc-author: Trelent
        """
        try:
    ...
    async def get_email_from_token(self, token: str):
        ...
        If so, it returns the email address stored in its sub field. If not, it raises an HTTPException indicating that
        the scope is invalid for this type of token.
